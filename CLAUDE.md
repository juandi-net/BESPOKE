...
Project guidance for any agent (Claude Code or other) working in this repo. This layers on top of
the user's global `~/.claude/CLAUDE.md` — don't repeat global rules here; this file is BESPOKE-specific.
